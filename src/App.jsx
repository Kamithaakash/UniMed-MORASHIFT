    ...
    if (text.includes('[Visit Type:') || text.includes('Symptoms:')) {
      ...
      return (
        <div className="consult-card">
          {/* Visit type + severity hero row */}
          <div className="consult-card-hero">
            <div className="consult-visit-type">
              <span className="consult-visit-icon">🩺</span>
              <span className="consult-visit-label">{visitType} Visit</span>
            </div>
            <div className={`consult-severity-pill ${sevMeta.cls}`}>
              <span className="consult-sev-icon">{sevMeta.icon}</span>
          ...
          <div className="consult-section">
            <div className="consult-section-header">
              ...
              <span className="consult-section-title">Symptoms</span>
            </div>
            <div className="consult-section-body">
              {symptomList.length > 1 ? (
                <ul className="consult-symptom-list">
                  {symptomList.map((s, i) => <li key={i}>{s}</li>)}
                </ul>
              ) : (
                <span className="consult-section-text">{symptoms}</span>
              )}
            </div>
          </div>
          ...
          <div className="consult-section">
            <div className="consult-section-header">
              <span className="consult-section-icon">📝</span>
              <span className="consult-section-title">Clinical Notes</span>
            </div>
            <div className="consult-section-body">
              <span className="consult-section-text consult-notes-text" style={{ whiteSpace: 'pre-wrap' }}>
                {notes || 'No further notes provided.'}
              </span>
            </div>
          </div>
        </div>
